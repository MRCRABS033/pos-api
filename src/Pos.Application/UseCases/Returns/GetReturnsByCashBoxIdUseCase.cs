...
public class GetReturnsByCashBoxIdUseCase
{
    private readonly IReturnRepository _returnRepository;

    public GetReturnsByCashBoxIdUseCase(IReturnRepository returnRepository)
    {
        _returnRepository = returnRepository;
    }

    public async Task<IReadOnlyList<ReturnResponseDto>> ExecuteAsync(Guid cashBoxId)
    {
        var returns = await _returnRepository.GetByCashBoxId(cashBoxId);
